...
def lists_to_tuple(l_one, l_two):
    ...
    l_two.extend([None for _ in range(diff) if diff != 0])
...
if __name__ == '__main__':
    ...
    result_one = [12, 44, 4, 10, 78, 123]
    lst_two = [2, 2, 2, 7, 23, 1, 44, 44, 3, 2, 10, 7, 4, 11]
    result_two = [23, 1, 3, 10, 4, 11]
    ...
    assert next_bigger_prev(lst_one) == result_one
    assert no_repeat(lst_two) == result_two
    print('Тест пройден!')
